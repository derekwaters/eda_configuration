...
- name: Create eda decision environment
  infra.eda_configuration.decision_environment:
    ...
    url: my-container_registry/ansible/de-minimal-8:latest
...
def main():
    ...
    existing_item = module.get_one("decision_environments", name_or_id=name, key="req_url")
    ...
    module.create_or_update_if_needed(
        existing_item,
        new_fields,
        endpoint="decision_environments",
        item_type="decision_environments",
        key="req_url",
    )
