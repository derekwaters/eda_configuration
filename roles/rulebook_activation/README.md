...
|:---:|:---:|:---:|:---:|
|`eda_configuration_rulebook_activation_secure_logging`|`False`|no|Whether or not to include the sensitive Project role tasks in the log.  Set this value to `True` if you will be providing your sensitive values from elsewhere.|
...
|`eda_configuration_rulebook_activation_async_retries`|`eda_configuration_async_retries`|no|This variable sets the number of retries to attempt for the role.|
|`eda_configuration_async_delay`|1|no|This sets the delay between retries for the role globally.|
|`eda_configuration_rulebook_activation_async_delay`|`eda_configuration_async_delay`|no|This sets the delay between retries for the role.|
...
|`project`|""|yes|str|The name of a project to associate with the rulebook activation.|
|`rulebook`|""|yes|str|The full path to the rulebook within the project to use for the rulebook activation.|
|`decision_environment`|""|yes|str|The name of a decision environment for use in the rulebook activation.|
|`restart_policy`|"always"|no|str|The policy for restarting the rulebook activation.|
|`is_enabled`|"true"|no|str|Whether the rulebook activation is enabled or not.|
|`variables`|""|no|dict|A dictionary of additional values to be passed to the rulebook.|
...
eda_rulebook_activations:
  - name: my_default_activation
    description: my default rulebook activation
    project: my_project
    rulebook: tests/examples/01_noop.yml
