...
|`eda_users`|`see below`|yes|Data structure describing your decision environments, described below.||
...
|:---:|:---:|:---:|:---:|
|`eda_configuration_user_secure_logging`|`False`|no|Whether or not to include the sensitive Project role tasks in the log.  Set this value to `True` if you will be providing your sensitive values from elsewhere.|
...
|:---:|:---:|:---:|:---:|:---:|
|`username`|""|yes|str|Username of the user. Must be lower case containing only alphanumeric characters and underscores.|
